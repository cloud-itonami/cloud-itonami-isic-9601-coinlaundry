(ns coinlaundry.operation
  "OperationActor -- one site operation = one supervised actor run,
  ...
  :approved}}`. `:actuation/suspend-machine` and
  `:actuation/hold-abandoned-property` ALWAYS reach this node when the governor
  is clean -- see `coinlaundry.phase`.
  ...
  (:require [langgraph.graph :as g]
            ...
            [coinlaundry.advisor :as advisor]
...
(defn build
  ...
  `coinlaundry.store/Store`).
  opts:
    :advisor      -- a `coinlaundry.advisor/Advisor` (default: mock-advisor)
